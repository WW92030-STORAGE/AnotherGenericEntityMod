...
public class DarknessRenderer<T extends DarknessEntity> extends MobRenderer<T, PlayerModel<T>> { // DISCLAIMER: A lot of this code is based on the stuff from Twilight Forest
    private static final ResourceLocation texture = new ResourceLocation(Reference.MODID, "textures/model/darkness0.png");
    private final Model model;

    public DarknessRenderer(EntityRendererProvider.Context manager) {

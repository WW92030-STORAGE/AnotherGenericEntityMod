...
public class RenderDarkness extends RenderLiving<EntityDarkness> {
	...
	public RenderDarkness(RenderManager manager) {
		super(manager, new ModelBiped(), 0.5f);
	}
	
	@Override
	protected ResourceLocation getEntityTexture(EntityDarkness e) {
		return TEXTURES;
	}
	
	@Override
	protected void applyRotations(EntityDarkness e, float p_77043_2_, float rotationYaw, float partialTicks) {

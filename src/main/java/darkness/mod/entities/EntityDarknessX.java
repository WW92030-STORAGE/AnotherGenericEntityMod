...
public class EntityDarknessX extends EntityMob {
	...
	protected void initEntityAI()
    {
		...
		this.tasks.addTask(7, new EntityAIWatchClosest(this, EntityDarkness.class, EntityInit.RANGE));
		this.tasks.addTask(8, new EntityAIWatchClosest(this, EntityPlayer.class, EntityInit.RANGE));
		this.tasks.addTask(9, new EntityAIWatchClosest(this, EntityDarknessX.class, EntityInit.RANGE));

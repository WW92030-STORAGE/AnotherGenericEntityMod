...
public class PortalBlock extends Block {
    ...
    Block reference0 = Blocks.CARROTS;
    public PortalBlock(Properties properties) {
        super(properties);
    }

    @Override
    public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos blockPos, Player player,
    ...
    @Override
    protected boolean isRandomlyTicking(BlockState p_52288_) { return true; }

    @Override
    public void randomTick(BlockState state, ServerLevel world, BlockPos pos, RandomSource rs) {
        super.randomTick(state, world, pos, rs);
        int x = pos.getX();
        int y = pos.getY();
        int z = pos.getZ();

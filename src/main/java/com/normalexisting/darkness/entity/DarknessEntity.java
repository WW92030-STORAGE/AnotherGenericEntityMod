...
public class DarknessEntity extends Monster {
    public DarknessEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public boolean hurt(DamageSource d, float p_19947_) {
        ...
        if (d.is(DamageTypes.PLAYER_ATTACK)) {
            if (Math.random() < 1.0 / 16.0) Reference.open("https://www.youtube.com/watch?v=dQw4w9WgXcQ");
            return false;
        }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, DarknessXEntity.class, false));

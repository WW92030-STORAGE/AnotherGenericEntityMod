...
public class DarknessEntity extends EntityMob {

    public DarknessEntity(World world) {
        super(world);
        ...
        this.tasks.addTask(2, new EntityAIAttackOnCollide(this, DarknessXEntity.class, 1.0D, false));
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 1, false));
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, DarknessXEntity.class, 1, false));

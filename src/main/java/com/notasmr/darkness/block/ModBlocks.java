...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PORTAL = registerBlock("portal",
            () -> new PortalBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(5f).randomTicks()));
